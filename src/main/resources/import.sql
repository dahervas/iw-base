...
--INSERT INTO product(id,idPropietario,nombre,descripcion,prestado,estrellitas,cantidad) VALUES (1, 1, 'Prueba de producto', 'Descripción de un producto de prueba', 0, 5, 1)