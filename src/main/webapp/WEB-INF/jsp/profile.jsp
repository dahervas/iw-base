...
<link href="/static/css/profile.css" rel = "stylesheet">
 <div class="todoAlCentro">
	 <div class="container">
	        ...
	        <h1 class=" mb-0" id="nombre">Marta 
	       
	        <span class="glyphicon glyphicon-cog" aria-hidden="true"></span>
	  
	        </h1>
	     	<div class="btn-group btn-group-lg justify-content-center" id= "botones" role="group" aria-label="Basic example">
	  			<button type="button" class="btn btn-secondary">Mis productos</button>
	  			<button type="button" class="btn btn-secondary">Mis colecciones</button>
			</div>
	</div>
